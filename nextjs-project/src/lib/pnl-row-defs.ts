...
export const ALL_DATA_KEYS = [
  ...
  'pilotPerDiem_perDiem', 'pilotPerDiem_bhBonus',
  'cabinCrewPerDiem_cabinAtt', 'cabinCrewPerDiem_seniorAtt',
  'spareParts_bh', 'spareParts_tiresWheels',
  'maintReservesFixed_6yr', 'maintReservesFixed_12yr', 'maintReservesFixed_ldg',
  'pilotSalary_pilot', 'pilotSalary_copilot',
  'cabinCrewSalary_cabinAtt', 'cabinCrewSalary_seniorAtt',
  'lineMaintenance_internal', 'lineMaintenance_3rdParty',
